...
class MainMenu:
    def __init__(self, _root):
        ...
        self.lab1_button = tk.Button(
            _root,
            text="Лабораторная работа 1: Редактор граф",
            width=50,
            command=self.open_lab1
        )
        self.lab1_button.pack(pady=10)

        self.lab2_button = tk.Button(
            _root,
            text="Лабораторная работа 2: Алгоритмы Дейкстры и Флойда",
            width=50,
            command=self.open_lab2
        )
        self.lab2_button.pack(pady=10)

        self.lab3_button = tk.Button(
            _root,
            text="Лабораторная работа 3: Симуляция передачи пакетов",
            width=50,
            command=self.open_lab3
        )
